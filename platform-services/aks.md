...
**Status:** User-confirmed ingress implementation. Cluster architecture, configuration, ownership, and operations remain to be documented.

**Source:** AKS ingress implementation supplied by the user on 2026-08-31.
...
This page does not confirm whether any Application Gateway frontend is public. A resource that requires public access must follow the [Public Access Exemption Process](../security/public-access-exemption-process.md).
...
| Identity and access | Controller identity, Azure and Kubernetes permissions, administrative access, and credential handling |
...
The entries above identify information to collect. They do not describe configuration or procedures already in place, and this page does not change any AKS, Application Gateway, or ingress configuration.
